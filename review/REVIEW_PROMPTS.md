...
당신은 NVIDIA 측 변호사처럼 행동해도 좋습니다 — 즉 본 감사가 NVIDIA 의 데이터셋을
...
(Nemotron-Personas-Korea, 1M 행) 에 대한 독립 감사 결과가 들어있습니다.

다음 4개 측면에서 이 감사를 객관적으로 평가하고, 마지막에 종합 판단을 내려주세요.
...
【종합 판단】
다음 형식으로 마무리:
- 본 감사의 핵심 결론 5개를 최대 신뢰도 / 보통 / 낮은 신뢰도로 분류
- 가장 큰 약점 3개
- 추가로 수행하면 좋을 검증 3개
- "이 감사를 인용해도 될 만한 신뢰도인가" 1줄 평
```
