...
- ⚠ **모집단 mismatch 주의**: Nemotron 은 **19세+**, reference 는 **15세+**. 15-18세 코호트는 거의 전원 미혼이므로 19+ 로 좁히면 (a) 미혼 비중이 줄고 (b) 배우자있음·사별·이혼 비중이 늘어남. Nemotron 의 차이는 이 **모집단 차이로 자연 발생하는 방향**과 일치.
